...
class Github {
  ...
  static issues({ owner, repo, pagination, sort, direction }) {
    const url = pagination.currentUrl ||
      `${Github.host}/repos/${owner}/${repo}/issues?state=all&page=${pagination.current}&per_page=${pagination.pageSize}&sort=${sort}&direction=${direction}`;
